import {crear, cambios, actualizar} from './firedatabasePruebas.js';
        ...
        function cargar(params="all") {
            ...
            cambios((listado) =>{
                ...
                listadoDragones.forEach(function (paramsDrag) {
                    ...
                    //se inserta el label para mostrar la placa
                    const labelPlaca = document.createElement("label");//creando el label
                    ...
                    labelPlaca.textContent =  paramsDrag.Alias;
